...
export const SectionCard = forwardRef<HTMLElement, SectionCardProps>(({
    ...
    return (
        <section
            ...
            id={id}
            className="w-full max-w-full bg-linear-to-br from-white via-white to-gray-50/50 backdrop-blur-sm rounded-2xl shadow-xl hover:shadow-2xl transition-shadow duration-500 overflow-hidden border border-gray-200/50 mb-8 will-change-transform"
            style={{
                opacity,
